     ...
     <div class="divTable" style="width: 100%; border: 0px solid #000;">
        <div class="divTableBody">
            ...
            <div class="divTableRow" >
                <div class="divTableCell" style="float: left; width: 55%;padding: 0 50px 50px 50px;text-align: center">
                    <div style="padding-top: 35px;">
                         <div class="container">
                             <form id="file-upload-form" class="uploader" action="{{Route('SaveProfile')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                 @csrf
                ...
                <div class="divTableRow">
                    ...
                    <div class="divTableCell" style="width: 65%"><input  type="text" id="datepicker-normal" name="PerCode" placeholder="Personel Code"/></div>
                    <div class="divTableCell">&nbsp;</div>
                </div>
            ...
            <div class="divTableRow">
                ...
                <div class="divTableCell" style="width: 65%"><input  type="text" id="datepicker-normal" name="Name"  placeholder="Name"  /></div>
                <div class="divTableCell">&nbsp;</div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">&nbsp;</div>
                <div class="divTableCell" ><b> <label  for="Family" >Family :</label> </b></div>
                <div class="divTableCell"><input  type="text" id="datepicker-normal" name="Family"  placeholder="Famliy" /></div>
                <div class="divTableCell">&nbsp;</div>
            </div>
                <div class="divTableRow">
                    <div class="divTableCell">&nbsp;</div>
                    <div class="divTableCell" ><b> <label  for="NCode" >National Cod :</label> </b></div>
                    <div class="divTableCell"><input  type="text" id="datepicker-normal" name="Ncode"  placeholder="National Cod" /></div>
                    <div class="divTableCell">&nbsp;</div>
                </div>
                <div class="divTableRow">
            ...
            <div class="divTableRow">
                ...
                <div class="divTableCell" >
                    ...
                    <select name="Unit">
                        <option hidden value="" disabled selected>Select your Unit</option>
            ...
            <div class="divTableRow">
                ...
                <div class="divTableCell">
                    <select name="Position">
                        <option hidden value="" disabled selected>Select your Position</option>
                        @foreach($ppName as $p)
